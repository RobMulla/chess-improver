...
def classify_by_win_loss(win_loss: float, position_complexity: float = 1.0) -> Dict:
    ...
    # (scaled by position complexity)
    BEST_THRESHOLD = 1.0 * scale        # <1% win loss
    EXCELLENT_THRESHOLD = 2.5 * scale   # <2.5%
    GOOD_THRESHOLD = 5.0 * scale        # <5%
    INACCURACY_THRESHOLD = 10.0 * scale # <10%
    MISTAKE_THRESHOLD = 15.0 * scale    # <15%
